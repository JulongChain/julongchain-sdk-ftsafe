 ...
 */
public class End2end_2_JoinGroup {

	private static JavaChainLog log = JavaChainLogFactory.getLog(End2end_2_JoinGroup.class);
...
//        System.info.flush();
    ...
    //
    //########################################################################################################################
    public static void joinGroup(String groupName, HFClient client, SampleOrg sampleOrg) throws InvalidArgumentException, ProposalException, TransactionException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        joinGroup("myGroup", client, sampleOrg);
        log.info("group has joined................");
