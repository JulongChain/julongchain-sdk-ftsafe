...
import static org.bcia.javachain.sdk.testutils.TestUtils.*;
...
//    public static final String INVALID_PEM_CERT = "";
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        plainText = DatatypeConverter.parseBase64Binary(PLAIN_TEXT_BASE64);
        sig = DatatypeConverter.parseBase64Binary(SIGNATURE_BASE64);
        pemCert = DatatypeConverter.parseBase64Binary(PEM_CERT_BASE64);
        invalidPemCert = DatatypeConverter.parseBase64Binary(INVALID_PEM_CERT_BASE64);
...
//----####<<<< by wangzhe
        ...
        BufferedInputStream fis = new BufferedInputStream(this.getClass().getResourceAsStream("/demoCA/cacert.pem"));
...
//        bis.close();
        ...
        fis = new BufferedInputStream(this.getClass().getResourceAsStream("/demoCert/server_cert.pem"));
        bytes = new byte[fis.available()];
		fis.read(bytes);
		Certificate cert = crypto.getX509Certificate(bytes);
        fis.close();

        PEMParser pem = new PEMParser(new InputStreamReader(this.getClass().getResourceAsStream("/demoCA/private/cakey.pem")));
...
//        System.err.println("_____verifyResult______"+ verifyResult);
    ...
    public void testBytesToCertificateInvalidBytes() throws CryptoException {
        crypto.bytesToCertificate(INVALID_PEM_CERT_BASE64.getBytes());
    }
    ...
    public void testBytesToPrivateKeyInvalidBytes() throws CryptoException {
        crypto.bytesToPrivateKey(INVALID_PEM_CERT_BASE64.getBytes());
    }
    ...
    public void testVerifyNullInput() {
        try {
        	byte[] b = null;
            assertFalse(crypto.verify(b, SIGNING_ALGORITHM, null, null));
        } catch (CryptoException e) {
...
//            bis.close();
            ...
            assertTrue(((GmCryptoPrimitives)crypto).verify(crypto.getTrustStore().getCertificate("ca"), SIGNING_ALGORITHM, signature, plainText));
