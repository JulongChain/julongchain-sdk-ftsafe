 ...
 */
package org.bcia.javachain_ca.sdk.helper;
...
public class Config {
    ...
    public static final String CACERTS = "org.bcia.javachain.sdk.cacerts";
    ...
    public static final String KEY_AGREEMENT_ALGORITHM = "org.bcia.javachain.sdk.crypto.key_agreement_algorithm";
    public static final String SYMMETRIC_KEY_TYPE = "org.bcia.javachain.sdk.crypto.symmetric_key_type";
    public static final String SYMMETRIC_KEY_BYTE_COUNT = "org.bcia.javachain.sdk.crypto.symmetric_key_byte_count";
    public static final String SYMMETRIC_ALGORITHM = "org.bcia.javachain.sdk.crypto.symmetric_algorithm";
    public static final String MAC_KEY_BYTE_COUNT = "org.bcia.javachain.sdk.crypto.mac_key_byte_count";
    ...
    public static final String LOGGERLEVEL = "org.bcia.javachain_ca.sdk.loglevel";  // ORG_HYPERLEDGER_FABRIC_CA_SDK_LOGLEVEL=TRACE,DEBUG
    ...
    private Config() {
        ...
        try {
            ...
            if (null != inLogLevel) {
                ...
                if (null != setTo) {
                    org.apache.log4j.Logger.getLogger("org.bcia.javachain_ca").setLevel(setTo);
                }
