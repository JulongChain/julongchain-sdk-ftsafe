...
import org.bcia.javachain.common.helper.MockCauthdsl;
import org.bcia.javachain.common.policies.config.IConfigPolicy;
import org.bcia.javachain.common.policies.config.ImplicitMetaAnyPolicy;
import org.bcia.javachain.common.policies.config.ImplicitMetaMajorityPolicy;
import org.bcia.javachain.common.policies.config.SignaturePolicy;
import org.bcia.javachain.sdk.security.msp.util.MspConfigHelper;
import org.bcia.javachain.common.util.proto.GenesisConfig;
...
public class ConfigTreeHelper {
    ...
    public static Configtx.ConfigTree buildConsenterOrgTree(GenesisConfig.Organization org) {
        ...
        //填充签名策略
        addSignaturePolicyDefaults(orgTreeBuilder, org.getId(), !GenesisConfig.DEFAULT_ADMIN_PRINCIPAL.equals(org
                .getAdminPrincipal()));
