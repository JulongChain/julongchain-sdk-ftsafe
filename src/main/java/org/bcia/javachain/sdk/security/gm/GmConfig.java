...
public class GmConfig {
    ...
    private GmConfig() {
        ...
        try {
             ...
             * for transactions sent to the Consenter. For internal cleanup only.
             */
     ...
     */
    public static GmConfig getConfig() {
        if (null == config) {
            config = new GmConfig();
        }
        return config;
     ...
     *
     * @return if true proposals will be checked they are consistent with each other before sending to the Consenter
     */
     ...
     * for transactions sent to the Consenter
     *
     * @return
     */
