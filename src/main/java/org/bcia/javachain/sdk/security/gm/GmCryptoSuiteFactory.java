...
/**
 * Factory to produce a set of crypto suite gm implementations offering differing cryptographic algorithms and strengths.
 */

public interface GmCryptoSuiteFactory extends CryptoSuiteFactory {
    ...
    static GmCryptoSuiteFactory getDefault() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
