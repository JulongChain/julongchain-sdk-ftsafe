...
public class StandardGroup implements IProcessor {
    ...
    private org.bcia.javachain.consenter.common.msgprocessor.RuleSet filters;

    public StandardGroup() {
    }

    public StandardGroup(IStandardGroupSupport standardGroupSupport, org.bcia.javachain.consenter.common.msgprocessor.RuleSet filters) {
        this.standardGroupSupport = standardGroupSupport;
        this.filters = filters;
    }

    public org.bcia.javachain.consenter.common.msgprocessor.RuleSet createStandardGroupFilters(IGroupConfigBundle filterSupport) {
